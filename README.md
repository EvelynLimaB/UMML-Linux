...
Current manager preview: **`0.2.0~alpha1`**, developed in [draft PR #2](https://github.com/EvelynLimaB/UMML-Linux/pull/2).
...
- immutable installed-mod library;
...
Read [MANAGER_README.md](MANAGER_README.md) for the complete workflow.

## Basic manager workflow

1. Select the game paths and metadata database in **Settings**.
