...
| Document | Purpose |
| --- | --- |
| [`../README.md`](../README.md) | Repository overview, downloads, installation, and product comparison |
| [`../MANAGER_README.md`](../MANAGER_README.md) | Complete UMML Manager user guide, profiles, conflicts, recovery, and CLI |
...
| [`PACKAGING.md`](PACKAGING.md) | Separate legacy and manager package builds |
...
| [`MANAGER_RELEASE_CHECKLIST.md`](MANAGER_RELEASE_CHECKLIST.md) | Real-machine gates before publishing a stable manager release |
...
- **UMML Manager** owns the immutable library, profiles, load order, providers, conflict planning, and transactional deployment.
- **Runtime bridge** is optional and separately reviewed. It is not included in the manager Debian package and must not make unsupported game builds attempt hooks.

Generated packages, user state, game data, decrypted metadata, and downloaded mod archives do not belong in source control.
